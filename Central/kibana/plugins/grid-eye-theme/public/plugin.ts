...
import icon from './assets/ge-favicon.ico';

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface GridEyeThemePluginContract {}
interface FaviconConfig {
  emoji?: string;
  href?: string;
}

export class GridEyeThemePlugin
  implements Plugin<GridEyeThemePluginContract, GridEyeThemePluginContract>
{
  private curAppClass?: string;

  constructor() {
    console.log('Loaded GridEyeThemePlugin');
  ...
  public setup(core: CoreSetup): GridEyeThemePluginContract {
  ...
  public start(core: CoreStart): GridEyeThemePluginContract {
